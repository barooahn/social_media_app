            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center space-y-4">
                    ...
                    <p className="max-w-2xl mx-auto text-gray-500 md:text-xl lg:text-2xl dark:text-gray-400">
                        Enhance your business&apos;s digital presence with our
                        comprehensive suite of marketing services. We&apos;re
                        dedicated to helping you achieve your sales and brand
                        awareness goals.
                    </p>
                </div>
                <div className="grid gap-12 py-12 md:grid-cols-2 lg:grid-cols-3">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            Technical analysis and strategic planning to improve
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            High-impact promotional videos and content to tell
                            your brand&apos;s story and captivate your audience.
                        </p>
                    </div>
                    <div className="space-y-4">
                        <h3 className="text-lg font-bold">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            ...
                            campaigns on various platforms, using A/B testing to
                            refine strategies.
                        </p>
                    </div>
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            ...
                            services, comparing your digital presence against
                            competitors.
                        </p>
                    </div>
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            Build a community around your brand by effectively
